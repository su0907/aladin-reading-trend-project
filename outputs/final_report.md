...
**계절성 패턴:**
```
베스트셀러 진입 비중 상위 3개 카테고리(소설, 경제경영, 만화)의 월별 트렌드를 분석함.

소설/시/희곡: 10월 급증 (2024년 한강 노벨문학상 효과)
경제경영: 12월~1월, 연초 증가 (연말정산, 신년 계획 시즌)
```
...
- **인문학 약 3배 성장:** 2020년 8% → 2025년 23% (+15%p)
- **경제경영 급감:** 2021년 20% → 2025년 8% (-12%p)
- **어린이 완만한 감소:** 2020년 15% → 2025년 10% (-5%p)

5년간 **인문학 증가, 경제경영 감소, 어린이 축소**라는 카테고리 구조 변화를 확인했습니다. 이는 외부 이벤트의 단기 충격과 대비되는 점진적·장기적 트렌드입니다.
...
본 프로젝트는 2020~2025년 알라딘 베스트셀러 3,517개를 분석하여 **외부 문화 이벤트가 출판 시장에 미치는 영향을 정량적으로 확인**했습니다.

**주요 발견:**
1. **외부 이벤트의 즉각적 영향**: 한강 노벨문학상 수상 후 베스트셀러 진입 8.6배 증가, 슬램덩크 영화 개봉으로 원작 만화 53회 진입
2. **장르 구성의 민감성**: 2022년 가격·페이지 하락은 일반 도서 자체 변화 + 저가 장르(만화/어린이) 비중 증가의 복합 효과
3. **장기 트렌드의 존재**: 인문학 3배 성장(8%→23%), 경제경영 급감(20%→8%) 등 점진적 구조 변화
